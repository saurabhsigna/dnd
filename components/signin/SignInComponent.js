        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto">
            ...
            >
                ...
                <div className="flex flex-wrap justify-between -m-2">
                  <div className="w-auto p-2">
                    <div className="relative flex items-center p-px bg-transparent overflow-hidden rounded-lg">
                      <input
                        className="form-input opacity-0 absolute z-10 h-5 w-5"
                        id="signInCheckbox1-1"
                        type="checkbox"
                        name="confirm"
                        value="yes"
                      />
                      ...
                      <label
                        className="relative z-10 text-white tracking-tight"
                        htmlFor="signInCheckbox1-1"
                      >
                        Remember me
                      </label>
                    </div>
                  ...
                  <div className="w-auto p-2">
                    <a
                      className="text-white hover:text-gray-200 tracking-tight"
                      href="#"
                    >
                      Forgot Password?
                    </a>
              ...
              <button
                type="submit"
                className="w-full p-3  inline-block mb-7 px-5 py-4 w-full text-white text-center font-semibold tracking-tight bg-indigo-500 hover:bg-indigo-600 rounded-lg focus:ring-4 focus:ring-indigo-300 transition duration-200"
              >
                Sign In
              </button>
            </form>
